...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post("https://aurora-8ke0.onrender.com/api/chat", {
      title
    }, {
  ...
  useEffect(() => {
    ...
    axios.get("https://aurora-8ke0.onrender.com/api/chat", { withCredentials: true })
      .then(response => {
        dispatch(setChats(response.data.chats.reverse()));
      })

    const tempSocket = io("https://aurora-8ke0.onrender.com", {
      withCredentials: true,
    })
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`https://aurora-8ke0.onrender.com/api/chat/messages/${chatId}`, { withCredentials: true })
